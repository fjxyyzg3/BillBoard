...
export const messages = {
  "zh-CN": {
    ...
    import: {
      eyebrow: "随手记导入",
      title: "导入记录",
      description: "上传随手记导出的 .xlsx，补齐分类映射后确认入账。",
      uploadTitle: "上传文件",
      uploadDescription: "选择随手记导出的 .xlsx 文件。",
      file: "文件",
      upload: "上传并解析",
      backToRecords: "返回记录",
      summaryTitle: "导入概览",
      ...
      errors: {
        "file-too-large": "文件过大，请上传不超过 20MB 的随手记 .xlsx 文件。",
  ...
  "en-US": {
    ...
    import: {
      eyebrow: "Sui Shou Ji import",
      title: "Import records",
      description: "Upload a Sui Shou Ji .xlsx export, map categories, then confirm the import.",
      uploadTitle: "Upload file",
      uploadDescription: "Choose the .xlsx file exported from Sui Shou Ji.",
      file: "File",
      ...
      errors: {
        "file-too-large": "File is too large. Upload a Sui Shou Ji .xlsx file up to 20MB.",
